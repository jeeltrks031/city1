...
const ProjectConfiguration = () => {
  ...
  return (
    <>
      <section className="overflow-hidden" style={{ background: "linear-gradient(180deg,#fff -1%,hsla(0,0%,100%,0) 36.54%,#fff 74.47%),url(webpack:///mini-css-extract-plugin/_next/static/media/bg.dcc56c30.png) #d3d3d3 -182.857px 0 /140.101% 75.655% no-repeat" }}>
                    ...
                    {activeIndex === index && (
                      ...
                      >
                        ...
                        <motion.button
                          ...
                          className="px-10 py-3 bg-[#BF843D] cursor-pointer text-white text-[16px] font-normal tracking-wide hover:bg-white/80 transition-all duration-300 hover:text-[#BF843D] border border-[#BF843D]"
